...
func main(){
    ...
    device := StartBLETransmitterTest(duration, uint8(channel))
...
func StartBLETransmitterTest(duration time.Duration , channel uint8) (gatt.Device) {
    ...
    // Begin transmission
    c := &cmd.LETransmitterTest{TxChannel:channel, LengthOfTestData:0, PacketPayload:0x00}
